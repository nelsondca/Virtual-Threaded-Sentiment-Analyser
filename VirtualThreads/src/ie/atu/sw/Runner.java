 ...
 * 
 *         /*The sentiment analysis application's entry point is the Runner
 *         class. It offers a console-based user interface so that the user may
 *         communicate with the application.
 * 
 *         Giving them the choice to select various sentiment analysis options.
 */
...
public class Runner {
	...
	public static void main(String[] args) throws Exception {
		...
		//Display the menu to the user and capture their selection
		...
		// Handle the user's menu selection
		 switch (option) { 
		// Option 1: Load and analyze tweets from a text file
		 case 1:
			 System.out.println("C:\Users\Morpheus\Desktop\New folder\lexicons\afinn.txt"); 
			 String textFilePath = scanner.next(); 
			 List<String> tweets = tweetReader.readTweetsFromFile(textFilePath); 
			 List<SentimentResult> results = tweetAnalyzer.analyzeTweets(tweets); 
