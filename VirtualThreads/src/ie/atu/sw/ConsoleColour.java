...
/**
 * * List different console colours and styles by use ANSI escape codes. On DOS,
 * Mac, and Linux terminals, ANSI escape codes are used to control the cursor
 * position, colour, font styling, *, and other settings. An simple * method of
 * accessing these codes in a Java application is provided by this enum.
 */

public enum ConsoleColour {
	// Annum constants for various console styles and colours
	RESET("Reset", "0"),
	...
	// ANSI control sequence introducer and terminator
	 ...
	 *
	 * @param description Description of the console colour or style.
	 * @param colour      ANSI escape code for the colour or style.
	 */
	...
	/**
	 * Returns the description of the console colour or style.
	 *
	 * @return Description of the colour or style.
	 */
	...
	/**
	 * Returns the ANSI escape code for the colour or style.
	 *
	...
	/**
	 * * ANSI escape sequence for the colour or style is returned by overriding the
	 * toString method. * @return Full ANSI escape sequence for the colour or style.
	 */
	@Override
